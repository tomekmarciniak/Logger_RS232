...
void UART0_Init(int baudrate)
{
	...
	LPC_UART0->FCR = 0x03;      // Enable and reset TX and RX FIFO
...
void UART3_Init(int baudrate)
{
	...
	// Set PINSEL1 so that P0.25 = TXD3, P0.26 = RXD3
	...
	LPC_UART3->FCR = 0x03;      // Enable and reset TX and RX FIFO
    LPC_UART3->FCR |= (3 << 6); // Set FIFO to trigger when at least 14 characters available
